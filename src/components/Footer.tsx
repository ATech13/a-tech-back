...
import { ATechLogo } from './ATechLogo';
    ...
    <footer className="bg-[#060F08] border-t border-[#a3e635]/20 relative z-7 pt-16 pb-8 text-gray-400 text-sm">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 pb-12 border-b border-white/10">
          ...
          <div className="space-y-4 md:col-span-1">
            ...
            <p className="text-xs text-gray-400 leading-relaxed">
              Développeur Full-Stack créant des expériences digitales modernes et performantes.
            </p>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs font-mono">
          ...
          <button
            onClick={scrollToTop}
            className="px-4 py-2 rounded-full bg-[#0F2818] border border-[#a3e635]/30 text-[#a3e635] hover:bg-[#a3e635] hover:text-[#08140B] transition-all flex items-center gap-2 cursor-pointer group"
          >
