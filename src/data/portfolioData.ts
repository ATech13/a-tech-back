...
import avatarImg from '../assets/bg/atech2.png';
import noboteImg from '../assets/projects/nobote.png';
import geniotechImg from '../assets/projects/geniotech.png';
import todolistImg from '../assets/projects/to-do-list.png';
import kitumainiImg from '../assets/projects/kitumaini.png';
import eclypseImg from '../assets/projects/eclypse.png';
import cvbuilderImg from '../assets/projects/cv1.png';
import worktrack from '../assets/projects/worktrack.png';
import fintrack from '../assets/projects/fin4.png';
import axiumarket from '../assets/projects/axium.png';

export const PERSONAL_INFO_FR = {
  name: "Aaron Tech",
  fullName: "Aaron Lumoo",
  title: "CEO & Cofondateur d'AXIUM | Développeur Full-Stack & Entrepreneur Tech",
  bio: "Je suis Aaron Tech, CEO et cofondateur d'AXIUM, ainsi que participant à des projets portés par la startup Rartech comme Noboté, Ecocinq et d'autres initiatives digitales d'impact. Je transforme des idées ambitieuses en produits concrets, performants et visibles sur le web.",
...
export const PERSONAL_INFO_EN = {
  name: "Aaron Tech",
  fullName: "Aaron Lumoo",
  title: "CEO & Co-founder at AXIUM | Full-Stack Developer & Tech Entrepreneur",
...
export const PROJECTS_FR: Project[] = [
  ...
  },
  {
    id: "kitumaini",
    title: "Kitumaini",
    subtitle: "Site d'entreprise & vitrine d'innovation",
    description: "Site web permettant de mettre en avant les services où l'entreprise Kitumaini œuvre avec un design pro.",
    fullDescription: "Présentation corporate complète des services d'ingénierie et de transformation digitale de Kitumaini. Intègre une galerie de projets interactifs, des calculateurs de devis personnalisés et une prise de rendez-vous en ligne.",
    image: kitumainiImg,
    tags: ["HTML", "CSS", "JS", "Bootstrap"],
    category: "Frontend",
    featured: false,
    ...
    githubUrl: "https://github.com/atech13",
    features: [
      "Design professionnel épuré aux normes internationales",
      "Module de prise de contact et devis automatisé",
      "Galerie portfolio de réalisations d'entreprise"
    ]
  },
  {
    id: "eclypse",
